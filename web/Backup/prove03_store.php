   ...
   <div id="div_sports" class="grid">
      ...
      <article class="card product-item">
         ...
         <div class="card__content">
            ...
            <p> Price $17.99</p>
            <br>
            <input class="cart_total" type="hidden" name="countbasketb" id="hiddenBasketBall" value="<?php if(isset($_SESSION['countbasketb'])){ ($_SESSION['countbasketb'] > 0 ?$_SESSION['countbasketb'] : 0 );  }?>"/>
      ...
      <article class="card product-item">
         ...
         <div class="card__content">
            ...
            <p> Price $18.99</p>
            <br>
            <input class="cart_total" type="hidden" name="countsb" id="hiddenSoccerBall" value="<?php if(isset($_SESSION['countsb'])){ ($_SESSION['countsb'] > 0 ?$_SESSION['countsb'] : 0 );  }?>" />
      ...
      <article class="card product-item">
         ...
         <div class="card__content">
            ...
            <p> Price $16.99</p>
            <br>
            <input class="cart_total" type="hidden" name="countvb" id="hiddenVolleyBall" value="<?php if(isset($_SESSION['countvb'])){ ($_SESSION['countvb'] > 0 ?$_SESSION['countvb'] : 0 );  }?>" />
      ...
      <article class="card product-item">
         ...
         <div class="card__content">
            ...
            <p> Price $17.99</p>
            <br>
            <input class="cart_total" type="hidden" name="countfb" id="hiddenFootBall" value="<?php if(isset($_SESSION['countfb'])){ ($_SESSION['countfb'] > 0 ?$_SESSION['countfb'] : 0 );  }?>" />
      ...
      <article class="card product-item">
         ...
         <div class="card__content">
            ...
            <p> Price $17.85</p>
            <br>
            <input class="cart_total" type="hidden" name="countbaseb" id="hiddenBaseBall" value="<?php if(isset($_SESSION['countbaseb'])){ ($_SESSION['countbaseb'] > 0 ?$_SESSION['countbaseb'] : 0 );  }?>" />
